...
const COMMON_POSITIONS = {
  ...
  engineer: [
    ...
    'Highway / Pavement Engineer','Structural / Bridge Engineer',
    'Geotechnical Engineer','Drainage / Hydraulics Engineer',
    'Traffic / Transport Engineer','Road Safety Auditor',
    'Claims / Contract Specialist','Quantity Surveyor (HQ)',
    'Design Review Engineer','Value Engineering Specialist',
    'Financial / Procurement Specialist','Legal Advisor',
